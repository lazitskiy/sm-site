...
class WideImage_Font_TTF
{
    ...
    function drawShadow($image, $x, $y, $text, $angle = 0, $shadow_px=2){
        ...
        $_x = array($shadow_px, 0, $shadow_px, 0, -$shadow_px, -$shadow_px, $shadow_px, 0, -$shadow_px); 
        $_y = array(0, -$shadow_px, -$shadow_px, 0, 0, -$shadow_px, $shadow_px, $shadow_px, $shadow_px); 

        for($n=0;$n<=8;$n++) { 
            ImageTTFText($image->getHandle(), $this->size, $angle, $fixed_x+$_x[$n], $fixed_y+$_y[$n],  $this->color, $this->face, $text); 
    ...
    function drawboldtext ($image, $x, $y, $text, $angle = 0){
